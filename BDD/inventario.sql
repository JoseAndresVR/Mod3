...
create table cabecera_pedido(
	numeroCp serial not null primary key,
...
INSERT INTO productos (nombre_producto, codigo_udm, precio, tiene_iva, coste, codigo_cat, stock) VALUES
( 'Licuadora', 'U', 0.80, true, 0.60, 1, 15),
('Televisor LED 50 pulgadas', 'U', 0.60, true, 0.40, 2, 10),
('Arroz', 'K', 0.20, true, 0.18, 3, 200),
('Agua mineral', 'L', 0.10, true, 0.50, 4, 300);
...
('2024-05-06 08:00:00', 'Compra proveedor 1', 1, 2),
('2024-05-06 08:00:00', 'Compra proveedor 1', 2, 1),
('2024-05-07 10:00:00', 'Compra proveedor 2', 3, 50),
('2024-05-07 10:00:00', 'Compra proveedor 2', 4, 100);

-- Insertar en cabecera_ventas
INSERT INTO cabecera_ventas (fecha, total_sin_iva, iva, total) VALUES
('2024-05-08 14:00:00', 2200, 352, 2552),
('2024-05-09 15:00:00', 250, 40, 290);
